            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('criterias.index') }}">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="stats-content">
                    ...
                    <div class="stats-sublabel">{{ $stats['active_users'] }} active</div>
                </div>
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                <div class="stats-content">
                    ...
                    <div class="stats-sublabel">{{ $stats['departments_count'] }} departments</div>
                </div>
                <div class="stats-icon">
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                <div class="stats-content">
                    ...
                    <div class="stats-sublabel">{{ $stats['evaluation_periods'] }} periods</div>
                </div>
                <div class="stats-icon">
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
                <div class="stats-content">
                    <div class="stats-number">{{ $stats['total_criteria'] }}</div>
                    <div class="stats-label">Criteria</div>
                    <div class="stats-sublabel">{{ $stats['criteria_weight_sum'] }}% total weight</div>
                </div>
                <div class="stats-icon">
                            ...
                            <div class="role-stats">
                                <div class="role-item">
                                    <div class="role-info">
                                        ...
                                        <span class="fw-medium">{{ $stats['admin_users'] }} users</span>
                                    </div>
                                    <div class="role-progress">
                                        <div class="progress">
                                            <div class="progress-bar bg-danger" style="width: {{ $stats['total_users'] > 0 ? ($stats['admin_users'] / $stats['total_users']) * 100 : 0 }}%"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="role-item">
                                    <div class="role-info">
                                        ...
                                        <span class="fw-medium">{{ $stats['manager_users'] }} users</span>
                                    </div>
                                    <div class="role-progress">
                                        <div class="progress">
                                            <div class="progress-bar bg-warning" style="width: {{ $stats['total_users'] > 0 ? ($stats['manager_users'] / $stats['total_users']) * 100 : 0 }}%"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="role-item">
                                    <div class="role-info">
                                        ...
                                        <span class="fw-medium">{{ $stats['regular_users'] }} users</span>
                                    </div>
                                    <div class="role-progress">
                                        <div class="progress">
                                            <div class="progress-bar bg-info" style="width: {{ $stats['total_users'] > 0 ? ($stats['regular_users'] / $stats['total_users']) * 100 : 0 }}%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="status-stats">
                                <div class="status-item">
                                    ...
                                    <div class="status-info">
                                        <div class="status-number">{{ $stats['active_users'] }}</div>
                                ...
                                <div class="status-item">
                                    ...
                                    <div class="status-info">
                                        <div class="status-number">{{ $stats['inactive_users'] }}</div>
                                ...
                                <div class="status-item">
                                    ...
                                    <div class="status-info">
                                        <div class="status-number">{{ $stats['verified_users'] }}</div>
                                ...
                                <div class="status-item">
                                    ...
                                    <div class="status-info">
                                        <div class="status-number">{{ $stats['unverified_users'] }}</div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="verification-progress">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        ...
                                        <span class="small fw-bold text-primary">{{ $stats['verification_rate'] ?? 0 }}%</span>
                                    </div>
                                    <div class="progress" style="height: 8px;">
                                        <div class="progress-bar bg-success"
                                             style="width: {{ $stats['verification_rate'] ?? 0 }}%"
                                             role="progressbar"
                                             aria-valuenow="{{ $stats['verification_rate'] ?? 0 }}"
                                             aria-valuemin="0"
                                             aria-valuemax="100">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between mt-2">
                                        <small class="text-success">
                                            <i class="fas fa-check-circle me-1"></i>{{ $stats['verified_users'] }} Verified
                                        </small>
                                        <small class="text-warning">
                                            <i class="fas fa-clock me-1"></i>{{ $stats['unverified_users'] ?? 0 }} Pending
                                        </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="health-metric">
                                ...
                                <div class="health-info">
                                    ...
                                    <small class="text-muted">{{ $stats['db_size'] ?? 'N/A' }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="health-metric">
                                ...
                                <div class="health-info">
                                    ...
                                    <small class="text-muted">{{ $stats['cache_size'] ?? 'N/A' }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="health-metric">
                                ...
                                <div class="health-info">
                                    ...
                                    <div class="health-status text-warning">{{ $stats['uptime'] ?? 'N/A' }}</div>
                                    <small class="text-muted">{{ $stats['last_restart'] ?? 'N/A' }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="quick-stats">
                        <div class="quick-stat-item">
                            ...
                            <div class="stat-value">{{ $stats['todays_logins'] ?? 0 }}</div>
                        </div>
                        <div class="quick-stat-item">
                            <div class="stat-label">New Users This Week</div>
                            <div class="stat-value">{{ $stats['weekly_new_users'] ?? 0 }}</div>
                        </div>
                        <div class="quick-stat-item">
                        ...
                        <div class="quick-stat-item">
                            ...
                            <div class="stat-value text-danger">{{ $stats['failed_logins'] ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
