...
@section('page-title', 'Evaluation List')
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('evaluations.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Evaluation period format: YYYY-MM (e.g., {{ date('Y-m') }})</li>
...
function forceDeleteEvaluation(evaluationIds) {
    ...
    if (confirm('This action cannot be undone. Are you sure?')) {
        $.ajax({
            url: '{{ route("evaluations.force-delete") }}',
            type: 'POST',
            data: {
                evaluation_ids: evaluationIds,
                _token: $('meta[name="csrf-token"]').attr('content')
