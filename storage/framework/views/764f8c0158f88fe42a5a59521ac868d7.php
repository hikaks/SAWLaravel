    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                <div class="stats-content">
                    <div class="stats-number"><?php echo e($stats['active_users']); ?></div>
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                <div class="stats-content">
                    <div class="stats-number"><?php echo e($stats['admin_users']); ?></div>
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
                <div class="stats-content">
                    <div class="stats-number"><?php echo e($stats['verified_users']); ?></div>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #ffecd2 0%, #fcb69f 100%); color: #333;">
                <div class="stats-content">
                    <div class="stats-number"><?php echo e($stats['unverified_users'] ?? 0); ?></div>
        ...
        <div class="col-md-3">
            <div class="card stats-card" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); color: #333;">
                <div class="stats-content">
                    <div class="stats-number"><?php echo e($stats['verification_rate'] ?? 0); ?>%</div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <div>
                                    <div class="h4 mb-0"><?php echo e($stats['verified_users']); ?></div>
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <div>
                                    <div class="h4 mb-0"><?php echo e($stats['unverified_users'] ?? 0); ?></div>
                                    <small>Pending</small>
                                </div>
                            </div>
                        </div>
...
function bulkAction(action) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "<?php echo e(route('users.bulk-action')); ?>",
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemograman\Laravel\SAWLaravel\resources\views/users/index.blade.php ENDPATH**/ ?>