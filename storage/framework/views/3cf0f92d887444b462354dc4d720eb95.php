<?php $__env->startSection('title', __('Sensitivity Analysis') . ' - ' . __('SAW Employee Evaluation')); ?>
<?php $__env->startSection('page-title', __('Sensitivity Analysis')); ?>

<?php $__env->startSection('content'); ?>
<!-- Header Section -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1 fw-bold"><?php echo e(__('Sensitivity Analysis')); ?></h1>
        <p class="text-muted mb-0"><?php echo e(__('Analyze how changes in criteria weights affect employee rankings')); ?></p>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">
                    ...
                    <?php echo e(__('Analysis Configuration')); ?>
                ...
                <form id="sensitivityForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="analysis_type" id="analysisType">
                            <option value="standard"><?php echo e(__('Standard Scenarios')); ?></option>
                            <option value="custom"><?php echo e(__('Custom Weights')); ?></option>
                        </select>
                    </div>
                    ...
                    <div id="customWeightsSection" style="display: none;">
                            ...
                            <?php $__currentLoopData = $criterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-3">
                                    <label class="form-label small">
                                        ...
                                        <span class="text-muted">(<?php echo e($criteria->type); ?>)</span>
                                    </label>
                                    <div class="input-group">
                                        <input type="range" class="form-range me-2" 
                                               ...
                                               oninput="updateWeightValue(<?php echo e($criteria->id); ?>)">
                                        <input type="number" class="form-control" 
                                               style="width: 80px;"
                                               min="1" max="100" 
                                               value="<?php echo e($criteria->weight); ?>" 
                                               id="weightValue_<?php echo e($criteria->id); ?>"
                                               onchange="updateWeightSlider(<?php echo e($criteria->id); ?>)">
                        ...
                        <div class="alert alert-info small">
                            ...
                            <?php echo e(__('Total weight will be normalized to 100%')); ?>
            ...
            <div class="card-body">
                <?php $__currentLoopData = $criterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <small class="text-muted"><?php echo e($criteria->name); ?></small>
                        <span class="badge bg-<?php echo e($criteria->type == 'benefit' ? 'success' : 'warning'); ?>">
                            <?php echo e($criteria->weight); ?>%
                        </span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="card-body">
                <div id="analysisResults">
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted"><?php echo e(__('No Analysis Results')); ?></h5>
                        <p class="text-muted"><?php echo e(__('Configure your analysis settings and click "Run Analysis" to see results.')); ?></p>
                    </div>
                </div>
                ...
                <div id="loadingResults" style="display: none;">
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted"><?php echo e(__('Running Analysis...')); ?></h5>
                        <p class="text-muted"><?php echo e(__('Please wait while we analyze the sensitivity of your criteria.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">
                    ...
                    <?php echo e(__('Sensitivity Summary')); ?>
    ...
    if (analysisType === 'custom') {
        ...
        <?php $__currentLoopData = $criterias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            requestData.weight_changes.push({
                criteria_id: <?php echo e($criteria->id); ?>,
                weight: parseInt($('#weightValue_<?php echo e($criteria->id); ?>').val())
            });
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    }
...
function showResultsTable() {
    ...
    html += '<thead><tr>';
    html += '<th><?php echo e(__("Employee")); ?></th>';
    html += '<th><?php echo e(__("Original Rank")); ?></th>';
    html += '<th><?php echo e(__("Original Score")); ?></th>';
        ...
        html += `<tr>
            ...
            <td>
                <button class="btn btn-sm btn-outline-info" onclick="showEmployeeDetails(${result.employee_id})">
                    <i class="fas fa-eye me-1"></i><?php echo e(__("Details")); ?>
...
function showResultsChart() {
    ...
    const chartData = {
        ...
        datasets: [{
            label: '<?php echo e(__("Original Score")); ?>',
...
function showSensitivitySummary() {
    ...
    html += '<div class="metric-label"><?php echo e(__("Average Stability")); ?></div>';
    html += '</div></div>';
    ...
    html += '<div class="metric-label"><?php echo e(__("Most Sensitive")); ?></div>';
    html += '</div></div>';
    ...
    html += '<div class="metric-label"><?php echo e(__("Most Stable")); ?></div>';
    html += '</div></div>';
    ...
    html += '<div class="metric-label"><?php echo e(__("Scenarios Analyzed")); ?></div>';
    html += '</div></div>';
...
function showScenarioResults() {
    ...
    let selectorHtml = '<option value=""><?php echo e(__("Select Scenario")); ?></option>';
...
function showScenarioDetails() {
    ...
    if (!selectedScenario || !analysisResults.sensitivity_scenarios[selectedScenario]) {
        $('#scenarioDetails').html('<p class="text-muted"><?php echo e(__("Select a scenario to view details")); ?></p>');
        return;
    }
    ...
    html += '<div class="metric-label"><?php echo e(__("Avg Rank Change")); ?></div>';
    html += '</div></div>';
    
    html += '<div class="col-md-3">';
    html += '<div class="sensitivity-metric">';
    html += `<div class="metric-value">${scenario.metrics.max_ranking_change}</div>`;
    html += '<div class="metric-label"><?php echo e(__("Max Rank Change")); ?></div>';
    html += '</div></div>';
    
    html += '<div class="col-md-3">';
    html += '<div class="sensitivity-metric">';
    html += `<div class="metric-value">${(scenario.metrics.stability_index * 100).toFixed(1)}%</div>`;
    html += '<div class="metric-label"><?php echo e(__("Stability Index")); ?></div>';
    html += '</div></div>';
    
    html += '<div class="col-md-3">';
    html += '<div class="sensitivity-metric">';
    html += `<div class="metric-value">${scenario.ranking_changes.length}</div>`;
    html += '<div class="metric-label"><?php echo e(__("Employees Affected")); ?></div>';
    html += '</div></div>';
    html += '</div>';
    ...
    html += '<thead><tr>';
    html += '<th><?php echo e(__("Employee")); ?></th>';
    html += '<th><?php echo e(__("Original")); ?></th>';
    html += '<th><?php echo e(__("New Rank")); ?></th>';
    html += '<th><?php echo e(__("Change")); ?></th>';
    html += '<th><?php echo e(__("Score Change")); ?></th>';
    html += '</tr></thead><tbody>';
...
function exportResults() {
    if (!analysisResults) {
        showError('<?php echo e(__("No results to export. Please run an analysis first.")); ?>');
        return;
    }
    
    // Implementation for export functionality
    showInfo('<?php echo e(__("Export functionality will be implemented soon.")); ?>');
}

function showEmployeeDetails(employeeId) {
    // Implementation for showing employee details
    showInfo('<?php echo e(__("Employee details functionality will be implemented soon.")); ?>');
}
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemograman\Laravel\SAWLaravel\resources\views/analysis/sensitivity.blade.php ENDPATH**/ ?>