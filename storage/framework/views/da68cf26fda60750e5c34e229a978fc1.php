<?php $__env->startSection('title', __('Employee Management') . ' - ' . __('SAW Employee Evaluation')); ?>
<?php $__env->startSection('page-title', __('Employee Management')); ?>

<?php $__env->startSection('content'); ?>
<!-- Header Section -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <p class="text-muted mb-0"><?php echo e(__('Manage and organize your employee data efficiently')); ?></p>
    </div>
    <div class="d-flex gap-2">
        <button class="btn btn-outline-secondary btn-sm" onclick="refreshTable()" data-bs-toggle="tooltip" title="<?php echo e(__('Refresh Data')); ?>">
        ...
        <div class="btn-group" role="group">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo e(route('employees.import-template')); ?>">
                    <i class="fas fa-download me-2"></i><?php echo e(__('Download Template')); ?>

                </a></li>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="#" onclick="showImportModal()">
                    <i class="fas fa-upload me-2"></i><?php echo e(__('Upload Data')); ?>
    ...
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
            <div class="stats-content">
                ...
                <div class="stats-label"><?php echo e(__('Evaluated')); ?></div>
            </div>
            <div class="stats-icon">
    ...
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);">
            <div class="stats-content">
                ...
                <div class="stats-label"><?php echo e(__('Departments')); ?></div>
            </div>
            <div class="stats-icon">
    ...
    <div class="col-md-3">
        <div class="stats-card" style="background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%);">
            <div class="stats-content">
                ...
                <div class="stats-label"><?php echo e(__('Active')); ?></div>
            </div>
            <div class="stats-icon">
    ...
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="mb-0 fw-semibold d-flex align-items-center">
                ...
                <?php echo e(__('Employee Directory')); ?>

            </h6>
            <div class="d-flex gap-2">
                <button class="btn btn-outline-primary btn-sm" onclick="exportData()" data-bs-toggle="tooltip" title="<?php echo e(__('Export Data')); ?>">
                    <i class="fas fa-download"></i>
                </button>
                <button class="btn btn-outline-warning btn-sm" onclick="showRestoreModal()" data-bs-toggle="tooltip" title="<?php echo e(__('Restore Deleted Employees')); ?>">
                    <i class="fas fa-undo"></i>
                </button>
                <button class="btn btn-outline-secondary btn-sm" onclick="toggleFilters()" data-bs-toggle="tooltip" title="<?php echo e(__('Toggle Filters')); ?>">
        ...
        <div class="collapse" id="filtersCollapse">
            <div class="alert alert-info p-3 mb-4">
                <h6 class="mb-3 fw-semibold">
                    <i class="fas fa-filter me-2"></i><?php echo e(__('Advanced Filters')); ?>

                </h6>
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label fw-medium"><?php echo e(__('Department')); ?></label>
                        <select class="form-select" id="departmentFilter">
                            <option value=""><?php echo e(__('All Departments')); ?></option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-medium"><?php echo e(__('Position')); ?></label>
                        <select class="form-select" id="positionFilter">
                            <option value=""><?php echo e(__('All Positions')); ?></option>
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-medium"><?php echo e(__('Evaluation Status')); ?></label>
                        <select class="form-select" id="evaluationFilter">
                            <option value=""><?php echo e(__('All Status')); ?></option>
                            <option value="evaluated"><?php echo e(__('Evaluated')); ?></option>
                            <option value="not_evaluated"><?php echo e(__('Not Evaluated')); ?></option>
                        </select>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <button class="btn btn-primary btn-sm" onclick="applyFilters()">
                            <i class="fas fa-search me-1"></i><?php echo e(__('Apply Filters')); ?>
            ...
            <table class="table table-hover align-middle" id="employeesTable">
                <thead>
                    <tr>
                        ...
                        <th width="20%"><?php echo e(__('Employee')); ?></th>
                        <th width="15%"><?php echo e(__('Position')); ?></th>
                        <th width="12%"><?php echo e(__('Department')); ?></th>
                        <th width="15%"><?php echo e(__('Contact')); ?></th>
                        <th width="10%"><?php echo e(__('Last Evaluation')); ?></th>
                        <th width="8%"><?php echo e(__('Ranking')); ?></th>
                        <th class="text-center" width="5%"><?php echo e(__('Actions')); ?></th>
                    </tr>
                </thead>
            </table>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="restoreModalLabel">
                    ...
                    <?php echo e(__('Restore Deleted Employees')); ?>
            ...
            <div class="modal-body">
                <div class="alert alert-info">
                    ...
                    <?php echo e(__('This will show all employees that have been deleted. You can restore them one by one or restore all at once.')); ?>

                </div>

                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="mb-0"><?php echo e(__('Deleted Employees')); ?></h6>
                    <div class="d-flex gap-2">
                ...
                <div id="noDeletedEmployees" class="text-center py-4" style="display: none;">
                    ...
                    <h6 class="text-success"><?php echo e(__('No Deleted Employees')); ?></h6>
                    <p class="text-muted"><?php echo e(__('All employees are currently active.')); ?></p>
                </div>
            </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importModalLabel">
                    <i class="fas fa-file-import me-2"></i><?php echo e(__('Import Employees')); ?>

                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="<?php echo e(route('employees.import')); ?>" method="POST" enctype="multipart/form-data" id="importForm">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
                    ...
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>
                        <strong><?php echo e(__('Important:')); ?></strong>
                        <ul class="mb-0 mt-2">
                            <li><?php echo e(__('Download the template first to see the required format')); ?></li>
                            <li><?php echo e(__('Employee codes must be unique')); ?></li>
                            <li><?php echo e(__('Email addresses must be valid and unique')); ?></li>
                            <li><?php echo e(__('Existing employees will be updated if found')); ?></li>
                        </ul>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-upload me-2"></i><?php echo e(__('Import Data')); ?>
...
function initializeDataTable() {
    employeesTable = $('#employeesTable').DataTable({
        ...
        columns: [
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <div class="fw-semibold">
                                    <a href="/employees/${row.id}" class="text-decoration-none text-primary fw-bold" data-bs-toggle="tooltip" title="<?php echo e(__('View Employee Details')); ?>">
                                        ${data}
                                    </a>
                                </div>
            ...
            },
            {
                ...
                render: function(data) {
                    ...
                    return `<small class="text-muted"><i class="fas fa-minus-circle me-1"></i><?php echo e(__('Not evaluated')); ?></small>`;
                }
            },
            {
                data: 'latest_ranking',
                    ...
                    return `
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="/employees/${row.id}" data-bs-toggle="tooltip" title="<?php echo e(__('View Full Details')); ?>">
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('evaluations.create')); ?>?employee_id=${row.id}" data-bs-toggle="tooltip" title="<?php echo e(__('Start Evaluation')); ?>">
                                        <i class="fas fa-clipboard-check text-success me-2"></i>
                                        <?php echo e(__('Start Evaluation')); ?>

                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="/employees/${row.id}/edit" data-bs-toggle="tooltip" title="<?php echo e(__('Edit Employee')); ?>">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li>
                                    <a class="dropdown-item text-danger" href="#" onclick="deleteEmployee(${row.id})" data-bs-toggle="tooltip" title="<?php echo e(__('Delete Employee')); ?>">
                                        <i class="fas fa-trash me-2"></i>
                                        <?php echo e(__('Delete Employee')); ?>
        ...
        language: {
            processing: '<div class="text-center"><div class="spinner-border text-primary me-2"></div><?php echo e(__("Processing...")); ?></div>',
...
function loadFilterOptions() {
    // Load departments
    $.get("<?php echo e(route('employees.index')); ?>", {get_departments: true})
        .done(function(response) {
            let departmentSelect = $('#departmentFilter');
            departmentSelect.empty().append('<option value=""><?php echo e(__("All Departments")); ?></option>');
    ...
    // Load positions
    $.get("<?php echo e(route('employees.index')); ?>", {get_positions: true})
        .done(function(response) {
            let positionSelect = $('#positionFilter');
            positionSelect.empty().append('<option value=""><?php echo e(__("All Positions")); ?></option>');
...
function loadStatistics() {
    $.get("<?php echo e(route('employees.index')); ?>", {get_stats: true})
        .done(function(response) {
            if (response.stats) {
...
function refreshTable() {
    ...
    Swal.fire({
        ...
        timer: 2000,
        icon: 'success',
        title: '<?php echo e(__("Data refreshed successfully")); ?>'
    });
}
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            text: response.message || '<?php echo e(__("Employee has been deleted successfully")); ?>',
                            timer: 3000,
                            showConfirmButton: false
                        });
                    } else {
                ...
                error: function(xhr) {
                    let message = xhr.responseJSON?.message || '<?php echo e(__("Error occurred while deleting employee")); ?>';
                    Swal.fire({
                        icon: 'error',
                        title: '<?php echo e(__("Error")); ?>',
                        text: message
...
function quickEvaluate(employeeId) {
    window.location.href = `<?php echo e(route('evaluations.create')); ?>?employee_id=${employeeId}`;
}
...
function exportData() {
    ...
    Swal.fire({
        ...
        text: '<?php echo e(__("Choose export format")); ?>',
        icon: 'question',
        showCancelButton: true,
        showDenyButton: true,
        confirmButtonText: '<i class="fas fa-file-pdf me-1"></i><?php echo e(__("PDF")); ?>',
        denyButtonText: '<i class="fas fa-file-excel me-1"></i><?php echo e(__("Excel")); ?>',
        cancelButtonText: '<?php echo e(__("Cancel")); ?>',
...
function loadDeletedEmployees() {
    $.get("<?php echo e(route('employees.index')); ?>", { get_deleted: true })
        .done(function(response) {
                ...
                <div class="card deleted-employee-card" data-employee-id="${employee.id}">
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="employee-info mb-3">
                            <div class="row g-2">
                                <div class="col-6">
                                    <small class="text-muted d-block"><?php echo e(__('Position')); ?></small>
                                    <span class="fw-medium">${employee.position || '-'}</span>
                                </div>
                                <div class="col-6">
                                    <small class="text-muted d-block"><?php echo e(__('Department')); ?></small>
                        ...
                        <div class="card-actions d-flex gap-2">
                            <button class="btn btn-outline-warning btn-sm flex-fill"
                                    ...
                                    title="<?php echo e(__('Restore Employee')); ?>">
...
function restoreAllEmployees() {
    ...
    Swal.fire({
        title: '<?php echo e(__("Restore Employees")); ?>',
        text: `<?php echo e(__("Are you sure you want to restore")); ?> ${employeeIds.length} <?php echo e(__("employee(s)")); ?>?`,
        icon: 'question',
        showCancelButton: true,
...
function restoreEmployees(employeeIds) {
    $.ajax({
        url: "<?php echo e(route('employees.restore')); ?>",
        type: 'POST',
        data: {
            _token: $('meta[name="csrf-token"]').attr('content'),
        ...
        success: function(response) {
            if (response.success) {
                Swal.fire({
                    ...
                    text: response.message || `<?php echo e(__("Successfully restored")); ?> ${employeeIds.length} <?php echo e(__("employee(s)")); ?>`,
                    timer: 3000,
                    showConfirmButton: false
                });
        ...
        error: function(xhr) {
            let message = xhr.responseJSON?.message || '<?php echo e(__("Error occurred while restoring employees")); ?>';
            Swal.fire({
                icon: 'error',
                title: '<?php echo e(__("Error")); ?>',
                text: message
...
function forceDeleteEmployees(employeeIds) {
    ...
    Swal.fire({
        title: '<?php echo e(__("Permanently Delete Employees")); ?>',
        text: `<?php echo e(__("This action cannot be undone! Are you sure you want to permanently delete")); ?> ${employeeIds.length} <?php echo e(__("employee(s)")); ?>?`,
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#dc3545',
        cancelButtonColor: '#6b7280',
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo e(route('employees.force-delete')); ?>",
                type: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    employee_ids: employeeIds
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            text: response.message || `<?php echo e(__("Successfully permanently deleted")); ?> ${employeeIds.length} <?php echo e(__("employee(s)")); ?>`,
                            timer: 3000,
                            showConfirmButton: false
                        });
                ...
                error: function(xhr) {
                    let message = xhr.responseJSON?.message || '<?php echo e(__("Error occurred while permanently deleting employees")); ?>';
                    Swal.fire({
                        icon: 'error',
                        title: '<?php echo e(__("Error")); ?>',
                        text: message
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemograman\Laravel\SAWLaravel\resources\views/employees/index.blade.php ENDPATH**/ ?>