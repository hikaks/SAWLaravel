        ...
        <div class="col-md-4">
            ...
            <div class="card profile-card shadow mb-4">
                <div class="card-body text-center">
                    ...
                    <h4 class="card-title mb-1"><?php echo e($user->name); ?></h4>
                    <p class="text-muted mb-3"><?php echo e($user->email); ?></p>

                    <!-- Status Badges -->
                    <div class="d-flex justify-content-center gap-2 mb-3">
                        <span class="badge bg-<?php echo e($user->role === 'admin' ? 'danger' : ($user->role === 'manager' ? 'warning' : 'info')); ?> px-3 py-2">
                            <i class="fas fa-user-tag me-1"></i><?php echo e(ucfirst($user->role)); ?>

                        </span>
                        <span class="badge bg-<?php echo e($user->is_active ? 'success' : 'secondary'); ?> px-3 py-2">
                            <i class="fas fa-<?php echo e($user->is_active ? 'check-circle' : 'times-circle'); ?> me-1"></i>
                    ...
                    <?php if($user->email_verified_at): ?>
                        <div class="alert alert-success py-2">
                            ...
                            <small class="d-block"><?php echo e($user->email_verified_at->format('M d, Y')); ?></small>
                        </div>
                    <?php else: ?>
                        <div class="alert alert-warning py-2">
                            ...
                            <?php if(auth()->user()->isAdmin()): ?>
                                <button class="btn btn-sm btn-outline-warning ms-2" onclick="sendVerificationEmail(<?php echo e($user->id); ?>)">
                                    Send Verification
                                </button>
                            <?php endif; ?>
                        </div>
                    ...
                    <?php if(auth()->user()->isAdmin() && auth()->user()->id !== $user->id): ?>
                        <div class="d-grid gap-2 mt-3">
                            <button class="btn btn-<?php echo e($user->is_active ? 'warning' : 'success'); ?> btn-sm"
                                    onclick="toggleUserStatus(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', <?php echo e($user->is_active ? 'false' : 'true'); ?>)">
                                <i class="fas fa-<?php echo e($user->is_active ? 'ban' : 'check'); ?> me-1"></i>
                                <?php echo e($user->is_active ? 'Deactivate' : 'Activate'); ?> User
                            </button>
                            <button class="btn btn-outline-primary btn-sm" onclick="sendPasswordReset(<?php echo e($user->id); ?>)">
                ...
                <div class="card-body">
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            ...
                            <small class="text-muted d-block"><?php echo e($user->created_at->diffForHumans()); ?></small>
                        </div>
                    </div>
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            ...
                            <?php echo e($stats['last_login'] ? $stats['last_login']->diffForHumans() : 'Never'); ?>
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">
                            ...
                            <?php echo e($stats['account_age']); ?> days
                        </div>
                    </div>
                    <?php if(auth()->user()->isAdmin()): ?>
                    <div class="info-item">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="card stats-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                        <div class="stats-content">
                            <div class="stats-number"><?php echo e($stats['total_logins']); ?></div>
                ...
                <div class="col-md-6">
                    <div class="card stats-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                        <div class="stats-content">
                            <div class="stats-number"><?php echo e($stats['evaluations_created']); ?></div>
            ...
            <div class="card permissions-card shadow mb-4">
                <div class="card-header">
                    <h6 class="mb-0">
                        ...
                        <span class="badge bg-<?php echo e($user->role === 'admin' ? 'danger' : ($user->role === 'manager' ? 'warning' : 'info')); ?> ms-2">
                        ...
                        <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="permission-item">
                                <div class="permission-icon">
                                    <i class="fas fa-<?php echo e($permission['icon']); ?> text-<?php echo e($permission['level'] === 'admin' ? 'danger' : ($permission['level'] === 'manager' ? 'warning' : 'info')); ?>"></i>
                                </div>
                                <div class="permission-text">
                                    <?php echo e($permission['text']); ?>

                                    <span class="badge bg-<?php echo e($permission['level'] === 'admin' ? 'danger' : ($permission['level'] === 'manager' ? 'warning' : 'info')); ?> ms-2">
                                        <?php echo e(ucfirst($permission['level'])); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemograman\Laravel\SAWLaravel\resources\views/users/show.blade.php ENDPATH**/ ?>