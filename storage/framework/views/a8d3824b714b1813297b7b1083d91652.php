    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group">
                    <a href="<?php echo e(route('users.show', $user->id)); ?>" class="btn btn-info">
        ...
        <div class="col-12">
            <div class="alert alert-info border-0 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-1"><strong><?php echo e($user->name); ?></strong></h6>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" id="userEditForm" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input"
                                                   ...
                                                   <?php echo e(auth()->user()->id === $user->id ? 'disabled' : ''); ?>>
                                            <label class="form-check-label" for="is_active">
                                                <strong>Active Account</strong>
                                                <small class="d-block text-muted">
                                                    <?php echo e(auth()->user()->id === $user->id ? 'Cannot deactivate your own account' : 'User can login and access the system'); ?>
                        ...
                        <!-- Admin Warning -->
                        <?php if($user->role === 'admin' && $user->id === auth()->user()->id): ?>
...
$(document).ready(function() {
    ...
    $('#role').change(function() {
        const role = $(this).val();
        if (role === 'admin' && <?php echo e(auth()->user()->id); ?> === <?php echo e($user->id); ?>) {
            Swal.fire({
                icon: 'warning',
                ...
                if (!result.isConfirmed) {
                    $(this).val('<?php echo e($user->role); ?>').trigger('change');
                }
            });
        }
    });
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemograman\Laravel\SAWLaravel\resources\views/users/edit.blade.php ENDPATH**/ ?>