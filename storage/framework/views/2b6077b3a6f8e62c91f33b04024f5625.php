<?php $__env->startSection('title', __('Multi-period Comparison') . ' - ' . __('SAW Employee Evaluation')); ?>
<?php $__env->startSection('page-title', __('Multi-period Comparison')); ?>

<?php $__env->startSection('content'); ?>
<!-- Header Section -->
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1 fw-bold"><?php echo e(__('Multi-period Comparison')); ?></h1>
        <p class="text-muted mb-0"><?php echo e(__('Compare performance across multiple evaluation periods')); ?></p>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <h6 class="mb-0">
                    ...
                    <?php echo e(__('Comparison Configuration')); ?>
            ...
            <div class="card-body">
                <form id="comparisonForm">
                    <div class="mb-3">
                        <label class="form-label"><?php echo e(__('Select Periods to Compare')); ?></label>
                            ...
                            <?php $__currentLoopData = $availablePeriods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" 
                                           value="<?php echo e($period); ?>" id="period_<?php echo e($loop->index); ?>"
                                           name="periods[]">
                                    <label class="form-check-label" for="period_<?php echo e($loop->index); ?>">
                                        <?php echo e($period); ?>
                        ...
                        <small class="text-muted"><?php echo e(__('Select 2-6 periods for comparison')); ?></small>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><?php echo e(__('Comparison Type')); ?></label>
                        <select class="form-select" name="comparison_type" id="comparisonType">
                            <option value="all"><?php echo e(__('All Employees')); ?></option>
                            <option value="specific"><?php echo e(__('Specific Employee')); ?></option>
                    ...
                    <div id="departmentOptions" style="display: none;">
                        <div class="mb-3">
                            <label class="form-label"><?php echo e(__('Select Department (Optional)')); ?></label>
                            <select class="form-select" name="department_id" id="departmentSelect">
                                <option value=""><?php echo e(__('All Departments')); ?></option>
                            </select>
                            <small class="text-muted"><?php echo e(__('Leave empty to compare all departments')); ?></small>
                        </div>
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            <?php echo e(__('Department comparison will show performance statistics grouped by department across selected periods.')); ?>
        ...
        <div id="loadingResults" style="display: none;">
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <h5><?php echo e(__('Running Multi-period Comparison...')); ?></h5>
                    <p class="text-muted"><?php echo e(__('Please wait while we analyze the data')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div id="comparisonResults" style="display: none;">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="mb-0"><?php echo e(__('Comparison Results')); ?></h6>
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">
                        ...
                        <?php echo e(__('Period Statistics')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemograman\Laravel\SAWLaravel\resources\views/analysis/comparison.blade.php ENDPATH**/ ?>